                    ...
                    <div class="card-body p-0">
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-flex">
                                <div class="flex-grow-1 bg-login-image" style="background-image: url(&quot;https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRHrbTnZj4YslckJ3DYC1GWkcDWVxJg41AogA&amp;usqp=CAU&quot;);"></div>
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <div class="text-center"><a class="small" href="index.php?controller=users&action=register">Create an Account!</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
