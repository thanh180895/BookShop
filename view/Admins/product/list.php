<div class="container-fluid">
    ...
    <div class="card shadow">
        ...
        <div class="card-body">
            <form method= "POST" action="admin.php?controller=products&action=search">
            <div class="row">
                ...
                <div class="col-md-6">                  
                    <div class="text-md-end dataTables_filter" id="dataTable_filter"><label class="form-label"><input type="search" name ="productName" class="form-control form-control-sm" aria-controls="dataTable" placeholder="Search"></label> <input type="submit" class="btn btn-info" style="float:right"value= "Search"></div>
                </div>  
                                    
                <div class ="text-end">
                <a href="admin.php?controller=products&action=add" type="button" class="btn btn-success"><i class="fas d-xl-flex justify-content-xl-center align-items-xl-center">ADD</i></a>      
                </div>
